...
import com.android.pacificist.helloandroid.loader.ImageLoader;
import com.android.pacificist.helloandroid.utils.Utils;
...
public class MainActivity extends AppCompatActivity implements OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsWifi = Utils.isWifiConnected(this);
        mCanGetBitmapFromNetWork = mIsWifi;
    ...
    private void initData() {
        String[] imageUrls = {
                ...
                "http://t2.hddhhn.com/uploads/tu/201804/9999/97ee54a2bd.jpg",
                "http://t2.hddhhn.com/uploads/tu/201804/9999/3e38e8a912.jpg",
                "http://t2.hddhhn.com/uploads/tu/201804/9999/271001cd27.jpg",
                "http://t2.hddhhn.com/uploads/tu/201804/9999/6fcc6fb582.jpg",
                "http://t2.hddhhn.com/uploads/tu/201804/9999/307acc30aa.jpg",
                "http://t2.hddhhn.com/uploads/tu/201804/9999/d1daf255df.jpg",
                "http://img2.ph.126.net/yqaJVfjhXwMbruf-O9U5xA==/2483735194512808182.jpg",
                "http://img5.ph.126.net/lE20pBNj3I4cusQhdq1Erg==/1027383665011784835.jpg",
                "http://img7.ph.126.net/CUdI9WMS6VaYQXciFmnmeA==/3103824568206180957.jpg",
                "http://img4.ph.126.net/YYRl8wfXYk4UIFqL4Tdx7Q==/3031485499191005904.jpg",
                "http://img7.ph.126.net/sdbgVAJp9YL8aR8WHpG1Uw==/1550364171740187657.jpg",
                "http://img4.ph.126.net/1yBucXLt2OFlLywrnZBEIg==/3062729221606388994.jpg" };
    ...
    private void initView() {
        mImageGridView = findViewById(R.id.gridView_main);
        ...
        if (!mIsWifi) {
            ...
            builder.setTitle(R.string.notice).setMessage(R.string.msg_no_wifi)
