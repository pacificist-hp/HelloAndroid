...
public class BinderPool {
    ...
    private static final String TAG = "BinderPool/Self";

    public static final int BINDER_NONE = -1;
    public static final int BINDER_COMPUTER = 0;
    public static final int BINDER_SECURER = 1;
    ...
    public IBinder queryBinder(int binderCode) {
        Log.d(TAG, "queryBinder in proxy: " + binderCode);
        IBinder binder = null;
        try {
            if (mBinderPool != null) {
    ...
    public static class BinderPoolImpl extends IBinderPool.Stub {
        ...
        public IBinder queryBinder(int binderCode) throws RemoteException {
            Log.d(TAG, "queryBinder in stub: " + binderCode);
            IBinder binder = null;
            switch (binderCode) {
                case BINDER_SECURER:
                    binder = new Securer();
